"""
Django settings for djangoProjectStore project.
...
SECRET_KEY = 'django-insecure--=lysj0srx9lo0h(*$#f$b(#z%n$=6vh(het5ubpm@au+*j)a+'
...
ROOT_URLCONF = 'djangoProjectStore.urls'
...
WSGI_APPLICATION = 'djangoProjectStore.wsgi.application'
